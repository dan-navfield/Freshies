 ...
 * Tracks last scanned product, routine products, and conversation history
 *
 * NOTE: Child profile context comes from ChildProfileContext, not this store
 */
 ...
 * NOTE: Child profile should be passed separately from ChildProfileContext
 */
